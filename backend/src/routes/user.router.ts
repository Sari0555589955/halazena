...
router.post(
  "/register",
  Authentication,
  checkRole(Roles.ADMIN, Roles.USER, Roles.SUPER_ADMIN),
  validate(userValidation, "post"),
  createUser
);
router.post(
  "/adminCreateUser",
...
router
  ...
  .post(
    Authentication,
    checkRole(Roles.SUPER_ADMIN, Roles.SUPER_ADMIN),
    validate(userValidation, "post"),
    addUserWithRole
  );
...
router
  ...
  .put(
    Authentication,
    checkRole(Roles.ADMIN, Roles.SUPER_ADMIN, Roles.USER),
...
router
  ...
  .delete(Authentication, checkRole(Roles.SUPER_ADMIN), deleteUser);
router
