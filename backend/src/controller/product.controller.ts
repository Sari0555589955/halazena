...
export const addProduct = async (req: AuthenticatedRequest, res: Response) => {
  ...
  if (req.params.category) {
    ...
    if (isCategoryFound) {
      ...
      const newCategory: any = new Category({ name: req.params.category })
...
export const getAllProduct = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    const productLength = await Product.find(filterationOption).countDocuments()
...
export const updateProduct = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    if (category) {
      ...
      foundCategory = await Category.findOne({ name: req.body.category })
    }
