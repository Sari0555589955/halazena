...
exports.getAllContact = ((0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const contacts = yield contact_model_1.default.find(filterationOpation).skip(skipLimit).limit(limit);
    if (!contacts[0]) {
...
exports.getContactById = ((0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const contact = yield contact_model_1.default.findByIdAndUpdate(req.params.contactId, { $set: { isOpened: true } });
    if (!contact) {
