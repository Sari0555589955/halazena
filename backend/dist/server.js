...
const options = {
    ...
    cert: fs_1.default.readFileSync(path_1.default.join(__dirname, `./key.crt`))
};
const ser = https_1.default.createServer(options, app);
const deleteGuestUser_1 = require("./automations/deleteGuestUser");
const deleteImages_1 = require("./automations/deleteImages");
joi_1.default.objectId = require("joi-objectid")(joi_1.default);
dotenv_1.default.config({ path: path_1.default.join(__dirname, './config/dev.env') });
(0, deleteGuestUser_1.deleteGuest)();
(0, deleteImages_1.deleteImages)();
